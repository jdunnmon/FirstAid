...
class DDSMDataOfficial:
    def __init__(self,root_path,label_json,image_path, test_image_path, mask_path='.', test_mask_path='.',n_splits=1,split_seed='None', mlo_only=False):
        self.mlo_only = mlo_only
    ...
    def write_splits(self,x_train,x_val,x_test,log_dir,suffix=""):
        ...
        train_direc = join(self.root_path,'train_set'+suffix)
        val_direc = join(self.root_path,'val_set'+suffix)
        test_direc = join(self.root_path,'test_set'+suffix)

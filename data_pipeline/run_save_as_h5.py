...
data_path = '/Volumes/ANN_HE/ddsm-processed'
...
save_as_h5(data_path, root_path, 'h5_train_set', train_image_path, train_mask_path, label_dictionary, train_valid_filenames, cropping_style='default')
...
save_as_h5(data_path, root_path, 'h5_test_set', test_image_path, test_mask_path, label_dictionary, test_valid_filenames, cropping_style='default')

val_valid_filenames = get_valid_files(load_image_names(root_path, val_image_path), load_image_names(root_path, val_mask_path))
save_as_h5(data_path, root_path, 'h5_val_set', val_image_path, val_mask_path, label_dictionary, val_valid_filenames, cropping_style='default')